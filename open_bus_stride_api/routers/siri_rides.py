...
def list_(limit: int = common.param_limit(),
          ...
          siri_route__line_refs: str = common.doc_param('siri route line refs', filter_type='list'),
          siri_route__operator_refs: str = common.doc_param('siri route operator refs', filter_type='list'),
          journey_ref_prefix: str = common.doc_param('journey ref', filter_type='prefix'),
          journey_refs: str = common.doc_param('journey ref', filter_type='list'),
          vehicle_refs: str = common.doc_param('vehicle ref', filter_type='list'),
          scheduled_start_time_from: datetime.datetime = common.doc_param('scheduled start time', filter_type='datetime_from'),
          scheduled_start_time_to: datetime.datetime = common.doc_param('scheduled start time', filter_type='datetime_to'),
