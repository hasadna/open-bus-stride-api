...
(select siri_ride.scheduled_start_time::timestamptz start_time from siri_ride
...
full outer join
(select gtfs_ride.start_time::timestamptz start_time, gtfs_ride.id gtfs_ride_id from gtfs_ride
