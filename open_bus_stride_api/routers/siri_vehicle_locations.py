...
def list_(limit: int = common.param_limit(LIST_MAX_LIMIT),
          ...
          lon__greater_or_equal: float = common.param_filter_greater_or_equal('lon', 34.808),
          lon__lower_or_equal: float = common.param_filter_lower_or_equal('lon', 34.808),
          lat__greater_or_equal: float = common.param_filter_greater_or_equal('lat', 31.961),
          lat__lower_or_equal: float = common.param_filter_lower_or_equal('lat', 31.961),
