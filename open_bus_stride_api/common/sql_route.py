...
def list_(sql, sql_params, default_limit, limit, offset, get_count, order_by, skip_order_by, allow_no_limit=False):
    ...
    try:
        if get_count:
            ...
            assert allow_no_limit or get_count or (sql_limit and 0 < limit <= 15000), "due to abuse, limit must be between 1 and 15000, contact us if you need more"
